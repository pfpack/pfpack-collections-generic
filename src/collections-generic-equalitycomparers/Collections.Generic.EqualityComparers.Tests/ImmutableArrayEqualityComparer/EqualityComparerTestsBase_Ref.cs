...
public sealed class EqualityComparerTestsBase_Ref
{
    ...
    public void Test_GetHashCode_SourceAreEqual_ExpectHashCodesAreEqual(CaseParamOfImmutableArray<string?> source1, CaseParamOfImmutableArray<string?> source2)
    {
    ...
    [Theory]
    [MemberData(nameof(SourceAreEqualCases))]
    public void Test_Equals_SourceAreEqual_ExpectTrue(CaseParamOfImmutableArray<string?> source1, CaseParamOfImmutableArray<string?> source2)
    {
    ...
    public void Test_Equals_SourceAreNotEqual_ExpectTrue(CaseParamOfImmutableArray<string?> source1, CaseParamOfImmutableArray<string?> source2)
    {
        var actualEquals = comparer.Equals(source1.Items, source2.Items);
